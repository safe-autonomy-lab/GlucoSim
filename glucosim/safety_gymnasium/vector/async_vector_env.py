...
from .vector_env import ArrayType, AutoresetMode, VectorEnv


__all__ = ["SafetyAsyncVectorEnv", "AsyncState"]
...
class SafetyAsyncVectorEnv(VectorEnv):
    ...
    Example:
        ...
        >>> observations, rewards, costs, terminations, truncations, infos = envs.step(envs.action_space.sample())
        >>> observations
    ...
    def step(
        ...
        Returns:
            Batch of (observations, rewards, costs, terminations, truncations, infos)
        """
    ...
    def step_wait(
        ...
        Returns:
             The batched environment step information, (obs, reward, cost, terminated, truncated, info)
        ...
        observations, rewards, costs, terminations, truncations, infos = [], [], [], [], [], {}
        successes = []
        for env_idx, pipe in enumerate(self.parent_pipes):
            ...
            if success:
                ...
                costs.append(env_step_return[2])
                terminations.append(env_step_return[3])
                truncations.append(env_step_return[4])
                infos = self._add_info(infos, env_step_return[5], env_idx)
            ...
            if command == "reset":
                ...
                if autoreset_mode == AutoresetMode.NEXT_STEP:
                    if autoreset:
                        ...
                        reward, cost, terminated, truncated = 0, 0, False, False
                    else:
                        (
                            observation,
                            reward,

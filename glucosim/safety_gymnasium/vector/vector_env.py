...
class VectorObservationWrapper(VectorWrapper):
    ...
    def step(
        ...
        observations, rewards, costs, terminations, truncations, infos = self.env.step(actions)
        return (
...
class VectorRewardWrapper(VectorWrapper):
    ...
    def step(
        ...
        observations, rewards, costs, terminations, truncations, infos = self.env.step(actions)
        return observations, self.rewards(rewards), self.costs(costs), terminations, truncations, infos
    ...
    def costs(self, costs: ArrayType) -> ArrayType:
        """Transform the cost before returning it.
